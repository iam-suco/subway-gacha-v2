...
sandwich_ingredients = {
    "ハム":["大豆","豚肉"],"たまご":["卵","大豆","りんご","ゼラチン","アルコール"],"ツナ":["卵","大豆","魚","アルコール"],
    "アボカドベジー":["アルコール"],"サラダチキン":["鶏肉"],"チリチキン":["鶏肉","りんご","アルコール"],"BLT":["ドライソーセージ","大豆","豚肉","鶏肉","アルコール"],
    "てり焼きチキン":["大豆","鶏肉","アルコール"],"えびたま":["えび","卵","大豆","りんご","ゼラチン","アルコール"],"えびアボカド":["えび","アルコール"],
    "生ハム&マスカルポーネ":["生ハム","マスカルポーネ","卵","豚肉"],"アボカドチキン":["鶏肉","アルコール"],"てりたま":["卵","大豆","鶏肉","りんご","ゼラチン","アルコール"],
    "スパイシークラブハウス":["ドライソーセージ","卵","大豆","鶏肉","りんご","ゼラチン","アルコール"],"アメリカンクラブハウス":["卵","大豆","豚肉"],"ローストビーフ":["卵","牛肉","大豆","りんご"]
}
...
topping_ingredients = {
    "ナチュラルチーズ":["ナチュラルチーズ"], "クリームタイプチーズ":["クリームタイプチーズ"], "マスカルポーネチーズ":["マスカルポーネ"], 
    "たまご":["卵","大豆","りんご","ゼラチン","アルコール"], "ベーコン":["ベーコン","豚肉"],"ツナ":["ツナ","卵","大豆","魚","アルコール"], 
    "えび":["えび"], "アボカド":["アボカド","アルコール"], "ハム":["ハム","豚肉"]
}

sauce_ingredients = {
    "オイル＆ビネガー":["オリーブオイル","ビネガー","アルコール"],"シーザー":["シーザー","卵","大豆","りんご","魚","アルコール"], "野菜クリーミー":["野菜クリーミー","大豆","りんご","アルコール"], 
