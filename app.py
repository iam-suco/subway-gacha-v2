...
sandwich_ingredients = {
    "ハム":["大豆","豚肉","ハム"], 
    "たまご":["卵","大豆","りんご","ゼラチン","アルコール"],
    "ツナ":["卵","大豆","魚","アルコール","ツナ"],
    "アボカドベジー":["アルコール","アボカド"], 
    "サラダチキン":["鶏肉"],
    "チリチキン":["鶏肉","りんご","アルコール"],
    "BLT":["ドライソーセージ","大豆","豚肉","鶏肉","アルコール"], # すでに入っているのでOK
    "てり焼きチキン":["大豆","鶏肉","アルコール"],
    "えびたま":["えび","卵","大豆","りんご","ゼラチン","アルコール"],
    "えびアボカド":["えび","アルコール","アボカド"], 
    "生ハム&マスカルポーネ":["生ハム","マスカルポーネ","卵","豚肉","生ハム","マスカルポーネ"], 
    "アボカドチキン":["鶏肉","アルコール","アボカド"], 
    "てりたま":["卵","大豆","鶏肉","りんご","ゼラチン","アルコール"],
    "スパイシークラブハウス":["ドライソーセージ","卵","大豆","鶏肉","りんご","ゼラチン","アルコール"], # OK
    "アメリカンクラブハウス":["卵","大豆","豚肉","ベーコン"], 
    "ローストビーフ":["卵","牛肉","大豆","りんご"]
}
